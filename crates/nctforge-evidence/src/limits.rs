...
use nctforge_core::{ContentReference, RegionMask};

use crate::ManifestError;

pub const IRRADIATION_TIME_SCHEMA: &str = "nctforge.irradiation-time-report/0.1.0";
...
impl IrradiationTimeReport {
    ...
    pub fn validate(&self) -> Result<(), ManifestError> {
        if self.schema_version != IRRADIATION_TIME_SCHEMA {
            return Err(ManifestError::Invalid(format!(
