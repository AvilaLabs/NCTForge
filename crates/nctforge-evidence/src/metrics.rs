...
pub const DOSE_METRICS_SCHEMA: &str = "nctforge.dose-metrics/0.1.0";
...
impl RegionDoseMetrics {
    ...
    /// functions in `nctforge-core` (percent in `(0, 100]`, non-negative
    ...
    pub fn validate(&self) -> Result<(), ManifestError> {
        if self.schema_version != DOSE_METRICS_SCHEMA {
