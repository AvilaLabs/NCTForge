...
pub const ENDF_REACTION_ENERGY_BALANCE_SCHEMA: &str = "nctforge.endf-reaction-energy-balance/0.1.0";
...
impl EndfReactionEnergyBalanceReport {
    ...
    pub fn validate(&self) -> Result<(), EndfReactionBalanceError> {
        if self.schema_version != ENDF_REACTION_ENERGY_BALANCE_SCHEMA {
