...
`NF-BNCT-001`. JEFF-4.0 is rejected for the frozen transported-photon KERMA
requirement: six of ten nuclides fail, none of the four baseline rejections is
resolved, and two new rejections are introduced.
