...
kinematic findings across C-13, O-17, and O-18. Diagnostic triage preserves
that total while assigning 59 C-13/O-18 findings to already source-data-blocked
runs and retaining 43 O-17 findings for independent reaction diagnostics. The
overall candidate remains unsuitable for response-table generation.
...
cargo run -p nctforge-cli -- njoy check-diagnostic-triage \
  ...
  --evidence-aware-report benchmarks/synthetic/nf-bnct-001/transport/candidates/jeff40/provenance/njoy2016-78-transported-photon-evidence-aware-suitability.json \
  --triage-report benchmarks/synthetic/nf-bnct-001/transport/candidates/jeff40/provenance/njoy2016-78-diagnostic-triage.json \
  --output NEW-DIAGNOSTIC-TRIAGE-CHECK.json
```
